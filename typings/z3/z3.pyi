...
class AstRef(Z3PPObject):
    ...
    def __deepcopy__(self, memo=...): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    ...
    def translate(self, target): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def __copy__(self): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
...
class FuncDeclRef(AstRef):
    ...
    def domain(self, i): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def range(self): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def __call__(self, *args): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class ExprRef(AstRef):
    ...
    def sort(self): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def arg(self, idx): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def children(self): # -> list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef] | list[Any]:
...
def deserialize(st): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def If(a, b, c, ctx=...): # -> Tactic | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def Const(name, sort): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def Consts(names, sort): # -> list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef]:
...
def FreshConst(sort, prefix=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    """Create a fresh constant of a specified sort"""
    ...

def Var(idx, s): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def RealVar(idx, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    """
...
def RealVarVector(n, ctx=...): # -> list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef]:
    """
...
class BoolRef(ExprRef):
    ...
    def __mul__(self, other): # -> Tactic | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class QuantifierRef(BoolRef):
    ...
    def __getitem__(self, arg): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def no_pattern(self, idx): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        """Return a no-pattern."""
        ...
    
    def body(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def var_sort(self, idx): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def children(self): # -> list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef]:
...
def ForAll(vs, body, weight=..., qid=..., skid=..., patterns=..., no_patterns=...): # -> BoolRef | QuantifierRef:
...
def Exists(vs, body, weight=..., qid=..., skid=..., patterns=..., no_patterns=...): # -> BoolRef | QuantifierRef:
...
class ArithSortRef(SortRef):
    ...
    def cast(self, val): # -> ArithRef | Tactic | PatternRef | QuantifierRef | BoolRef | IntNumRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef | None:
...
def RatVal(a, b, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def Q(a, b, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    """Return a Z3 rational a/b.
...
class ArraySortRef(SortRef):
    """Array sorts."""
    def domain(self): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def domain_n(self, i): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
        """Return the domain of the array sort `self`.
        """
        ...
...
class ArrayRef(ExprRef):
    ...
    def default(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
...
def Update(a, *args): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def Store(a, *args): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    """Return a Z3 store array expression.
...
def Ext(a, b): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def SetHasSize(a, k): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
...
class Goal(Z3PPObject):
    ...
    """
    def __init__(self, models=..., unsat_cores=..., proofs=..., ctx=..., goal=...) -> None:
        ...
    ...
    def get(self, i): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def as_expr(self): # -> BoolRef | PatternRef | QuantifierRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef | Probe:
...
class AstVector(Z3PPObject):
    ...
    def __getitem__(self, i): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef | list[Any] | None:
...
class AstMap:
    ...
    def __getitem__(self, key): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class FuncEntry:
    ...
    def arg_value(self, idx): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def value(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def as_list(self): # -> list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef]:
...
class FuncInterp(Z3PPObject):
    ...
    def else_value(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef | None:
        """
    ...
    def as_list(self): # -> list[list[PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef]]:
...
class ModelRef(Z3PPObject):
    ...
    def eval(self, t, model_completion=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def evaluate(self, t, model_completion=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        """Alias for `eval`.
    ...
    def get_sort(self, idx): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
    ...
    def sorts(self): # -> list[BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef]:
...
class CheckSatResult:
    ...
    def __repr__(self): # -> Literal['<b>sat</b>', '<b>unsat</b>', '<b>unknown</b>', 'sat', 'unsat', 'unknown']:
        ...
...
class Solver(Z3PPObject):
    ...
    def consequences(self, assumptions, variables): # -> tuple[CheckSatResult, list[BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef | FuncDeclRef | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef | list[Any] | None]]:
    ...
    def root(self, t): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def next(self, t): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def proof(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class Fixedpoint(Z3PPObject):
    ...
    def get_answer(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        """Retrieve answer from last query call."""
        ...
    
    def get_ground_sat_answer(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
    def get_cover_delta(self, level, predicate): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class OptimizeObjective:
    ...
    def lower(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def upper(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
...
class Optimize(Z3PPObject):
    ...
    def add_soft(self, arg, weight=..., id=...): # -> list[OptimizeObjective] | OptimizeObjective:
    ...
    def lower(self, obj): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def upper(self, obj): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
...
def simplify(a, *arguments, **keywords): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def substitute(t, *m): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def substitute_vars(t, *m): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def substitute_funs(t, *m): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
def Abs(arg): # -> Tactic | PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
...
class SeqSortRef(SortRef):
    ...
    def basis(self): # -> BoolSortRef | ArithSortRef | BitVecSortRef | ArraySortRef | DatatypeSortRef | FiniteDomainSortRef | FPSortRef | FPRMSortRef | ReSortRef | SeqSortRef | CharSortRef | TypeVarRef | SortRef:
        ...
...
class SeqRef(ExprRef):
    ...
    def __getitem__(self, i): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
...
class CharRef(ExprRef):
    ...
    def to_int(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def to_bv(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    
    def is_digit(self): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
        ...
    


def CharVal(ch, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...

def CharFromBv(bv): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...

def CharToBv(ch, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...

def CharToInt(ch, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...

def CharIsDigit(ch, ctx=...): # -> PatternRef | QuantifierRef | BoolRef | IntNumRef | ArithRef | RatNumRef | AlgebraicNumRef | BitVecNumRef | BitVecRef | ArrayRef | DatatypeRef | FPNumRef | FPRef | FiniteDomainNumRef | FiniteDomainRef | FPRMRef | SeqRef | CharRef | ReRef | ExprRef:
    ...
...
def user_prop_decide(ctx, cb, t, idx, phase): # -> None:
    ...
